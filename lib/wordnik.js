...
//The request() callback function takes three arguments – error, response, and body. As the name implies, error contains information regarding any problems 
//that occurred during the HTTP request. The response argument is an object containing a variety of data returned from the call, 
//including the status code, headers, and much more. The third callback argument, body, is the body of the response.
